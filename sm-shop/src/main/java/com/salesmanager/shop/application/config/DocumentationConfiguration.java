...
public class DocumentationConfiguration {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("eShopie", "http://www.eShopie.com", "");
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("eShopie REST API",
				"API for eShopie e-commerce. Contains public end points as well as private end points requiring basic authentication and remote authentication based on jwt bearer token. URL patterns containing /private/** use bearer token; those are authorized customer and administrators administration actions.",
