...
/*		List<String> services = options.get("services");
	...
	public List<ShippingOption> getShippingQuotes(
		...
		try {
			...
			String xml = "<?xml version=\"1.0\"?><RatingServiceSelectionRequest><Request><TransactionReference><CustomerContext>eShopie</CustomerContext><XpciVersion>1.0001</XpciVersion></TransactionReference><RequestAction>Rate</RequestAction><RequestOption>Shop</RequestOption></Request>";
